                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="{{asset('public/newfrontend/assets/images/demos/demo-20/BB8E3572-A716-422E-972F-5DA6F045D6A9-removebg-preview.png')}}" alt="CoolAdmin">
                            </a>
                        </div>
                        ...
                        <div class="login-form">
                            ...
                            ?>
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" placeholder="Tên Đăng Nhập" name="admin_user">
                                </div>
                                <div class="form-group">
